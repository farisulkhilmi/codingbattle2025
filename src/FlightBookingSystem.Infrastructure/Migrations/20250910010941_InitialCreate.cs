        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledDay = table.Column<int>(type: "INTEGER", nullable: false),
                    SeatAvailibity = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightRoutes_Aircrafts_AircraftId",
                        column: x => x.AircraftId,
                        principalTable: "Aircrafts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightRoutes_Destinations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Destinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightRoutes_Destinations_OriginId",
                        column: x => x.OriginId,
                        principalTable: "Destinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    FlightRouteId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ScheduledDay = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_AircraftId",
                table: "FlightRoutes",
                column: "AircraftId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_DestinationId",
                table: "FlightRoutes",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_OriginId",
                table: "FlightRoutes",
                column: "OriginId");
